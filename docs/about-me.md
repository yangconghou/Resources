...
### 高济大数据开发平台(PC) Vue2 2018.9 –2018.11
...
### 高济医疗桌面客户端(Mac/Windows) Vue2 2017.12 –2018.6
...
### 药店并购系统(PC/移动端) Vue2 2017.6—2017.11
...
NodeJS 作为前端页面 Server，大前端 Nginx 做负载均衡和反向代理。 业务逻辑实现使用 Vue+Router+ElementUI(mint-UI)。Less+flex+rem 实现自适应设备的响应式页面。
